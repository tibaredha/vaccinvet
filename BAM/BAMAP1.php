...
$per ->h(2,80,180,'Pathologie Apicole: Dr:'.$_SESSION["USER"]."  AVN: ".$_SESSION["AVN"]);
$per -> sautligne (8);
$per ->f0('index.php?uc=BAMAP','post','formGCS');
$per ->submit(1110,250,'Pathologie Apicole:');
...
{
header("Location: ./index.php?uc=BAMAP") ;
}
