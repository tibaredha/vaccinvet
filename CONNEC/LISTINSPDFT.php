...
$avnd=$pdf->avndlist();
$avnd1=$pdf->avndlist1();
$pdf->listvet("Liste des Vétérinaires Praticiens Privés du Dr : $avnd1 -> AVN: $avnd \n Arrété au ".date('d-m-Y'));
$h=65;
$pdf->SetXY(05,$h); 	  
...
$query = "SELECT * from users where AVND=$avnd   order by user";
...
$pdf->cell(140,05,"Dr: ".$avnd1."->AVN:".$avnd,1,0,'C',0);	 
$pdf->Output();
?>