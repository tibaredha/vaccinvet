...
$sqli = "INSERT INTO stock (date,AVN,EVAC,RVAC,EVAA,RVAA,EVAR,RVAR,EVAB,RVAB) VALUES ('".$dateeuro."','".$avn."','".$EVAC."','".$MVAC."','".$EVAA."','".$MVAA."','".$EVAR."','".$MVAR."','".$EVAB."','".$MVAB."')";
$requete = @mysql_query($sqli, $cnx) or die($sql."<br>".mysql_error());
header("Location: ../index.php?uc=ENTCOM") ;
?>
