...
$per ->h(2,240,180,'Stock de Produit du Dr:'.$_SESSION["USER"]."  ".$avn);
$per -> sautligne (2);
// $per -> photos(1000,250);
$per ->f0('./5EVA/***.PHP','post','formGCS');
// $per ->submit(965,200,'Imprimer Stock Produit');
$x=500;
$dateeuro=date('d/m/Y');
$y=220;
...
<td COLSPAN=2 class=\"ligne\">Date  <input type=\"text\" name=\"DATE\" value=\"$dateeuro\" size=\"10\" /><input   type=\"hidden\" name=\"AVN\" value=\"$avn\" size=\"10\" /></div></td>
