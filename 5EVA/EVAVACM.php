...
$pdf->AddPage('P','A4');
$pdf->SetFont('aefurat', '', 10);
$pdf->bilanentetef("BILAN MENSUEL DE VACCINATION ANTI-CLAVELEUSE \n PERIODE DU $datejour11 AU $datejour22 ");
$pdf->corps3();
...
$avn=$pdf->avn();
	...
	$DPVAC=$row['DPVAC'];
	mysql_free_result($requete);
	//NBR D ELEVEUR a verifier pose probleme avec autre vaccin 
...
$pdf->bilanenteteF("BILAN MENSUEL DE VACCINATION  ANTI-BRUCELLIQUE\n PERIODE DU $datejour11 AU $datejour22 ");
$pdf->corps3();
// $h1=50;
// $pdf->SetXY(05,$h1); 	  
...
// $pdf->SetXY($pdf->GetX(),$h1); 	  
// $pdf->cell(25,14,"Nbr ovins ",1,0,'C',0);
// $pdf->SetXY($pdf->GetX(),$h1); 	  
...
// while($row=mysql_fetch_object($resultat))
  ...
  // }
	...
	mysql_free_result($requete);
    //NBR D ELEVEUR   a verifier  pose probleme avec autre vaccin 
    $query_liste = "SELECT datevac,vabc1,vabc2,vabc3,vabc4,vabc5,vabc6,vabc7 FROM regvac where vabc1 !=0 and datevac >='$datejour1'and datevac <='$datejour2' and AVN='$avn'  ";
	$requete = mysql_query( $query_liste, $cnx ) or die( "ERREUR MYSQL num?: ".mysql_errno()."<br>Type de cette erreur: ".mysql_error()."<br>\n" );
	$NBRELEVEUR=mysql_num_rows($requete);
	mysql_free_result($requete);
...
$pdf->cell(100,10,"NOMBRE D OVINS VACCINES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalovins,1,0,'C',0);	
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE CAPRINS VACCINES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalovins1,1,0,'C',0);  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE D ELEVEURS TOUCHES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$NBRELEVEUR,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSE DE VACCIN RECEPTIONNEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalovins+$totalovins1+$DPVAB,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES PERDUS",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$DPVAB,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES RESTITUEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,"00",1,0,'C',0);
$pdf->Text(110,$pdf->GetY()+20,$pdf->nbrtodaira('vaccinvet','dai',$_SESSION["DAIRA"])." le: ".date('d/m/Y'));	  
$pdf->Text(20,$pdf->GetY()+10,"Signature de l'IVW  ");$pdf->Text(110,$pdf->GetY(),"Griffe et Signature du vétérinaire mandaté ");
...
$pdf->SetFont('aefurat', '', 10);
//$pdf->Image('../IMAGES/logoao.gif',90,25,15,15,0);
$pdf->bilanentetef("BILAN MENSUEL DE VACCINATION  ANTI-APHTEUSE \n PERIODE DU $datejour11 AU $datejour22 ");
$pdf->corps3();
// $h1=50;
// $pdf->SetXY(05,$h1); 	  
// $pdf->cell(10,14,"N°",1,0,'C',0);
...
// while($row=mysql_fetch_object($resultat))
  ...
  // }
   ...
   // Vaches Génisses
	...
	mysql_free_result($requete);
	 //NBR D ELEVEUR   a verifier  pose probleme avec autre vaccin 
    $query_liste = "SELECT datevac FROM regvac where vaad1 !=0 and datevac >='$datejour1'and datevac <='$datejour2' and AVN='$avn'  ";
	$requete = mysql_query( $query_liste, $cnx ) or die( "ERREUR MYSQL num?: ".mysql_errno()."<br>Type de cette erreur: ".mysql_error()."<br>\n" );
	$NBRELEVEUR=mysql_num_rows($requete);
	mysql_free_result($requete);
...
$pdf->SetFont('aefurat', '', 11);	
$pdf->SetXY(05,$pdf->GetY()); 	  
$pdf->cell(100,10,"NOMBRE BOVINS VACCINES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalbovins,1,0,'C',0);	
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE D ELEVEURS TOUCHES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$NBRELEVEUR,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSE DE VACCIN RECEPTIONNEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalbovins+$DPVAA,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES PERDUS",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$DPVAA,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES RESTITUEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,"00",1,0,'C',0);
$pdf->Text(110,$pdf->GetY()+20,$pdf->nbrtodaira('vaccinvet','dai',$_SESSION["DAIRA"])." le: ".date('d/m/Y'));	  
$pdf->Text(20,$pdf->GetY()+10,"Signature de l'IVW  ");$pdf->Text(110,$pdf->GetY(),"Griffe et Signature du vétérinaire mandaté ");
...
$pdf->SetFont('aefurat', '', 10);
//$pdf->Image('../IMAGES/logoao.gif',90,25,15,15,0);
$pdf->bilanentetef("BILAN MENSUEL DE VACCINATION  ANTI-RABIQUE \n PERIODE DU $datejour11 AU $datejour22 ");
$pdf->corps3();
// $h1=50;
// $pdf->SetXY(05,$h1); 	  
// $pdf->cell(10,14,"N°",1,0,'C',0);
...
$totalbovins=$Qvare1+$Qvare2+$Qvare3+$Qvare4+$Qvare5+$Qvare6;
 //NBR D ELEVEUR   a verifier  pose probleme avec autre vaccin 
    $query_liste = "SELECT datevac FROM regvac where vare1 !=0 and datevac >='$datejour1'and datevac <='$datejour2' and AVN='$avn'  ";
	$requete = mysql_query( $query_liste, $cnx ) or die( "ERREUR MYSQL num?: ".mysql_errno()."<br>Type de cette erreur: ".mysql_error()."<br>\n" );
	$NBRELEVEUR=mysql_num_rows($requete);
	mysql_free_result($requete);
...
$pdf->cell(100,10,"NOMBRE D ELEVEURS TOUCHES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$NBRELEVEUR,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSE DE VACCIN RECEPTIONNEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$totalbovins+$DPVAR,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES PERDUS",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,$DPVAR,1,0,'C',0);	  
$pdf->SetXY(05,$pdf->GetY()+10); 	  
$pdf->cell(100,10,"NOMBRE DE DOSES RESTITUEES",1,0,'L',0);$pdf->SetXY(105,$pdf->GetY()); $pdf->cell(100,10,"00",1,0,'C',0);
$pdf->Text(110,$pdf->GetY()+20,$pdf->nbrtodaira('vaccinvet','dai',$_SESSION["DAIRA"])." le: ".date('d/m/Y'));	  
$pdf->Text(20,$pdf->GetY()+10,"Signature de l'IVW  ");$pdf->Text(110,$pdf->GetY(),"Griffe et Signature du vétérinaire mandaté ");
