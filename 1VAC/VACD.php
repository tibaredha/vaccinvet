...
{
$query_liste = "SELECT * FROM regvac where  DAI='$DAIRA'";
 ...
 if($result[2]!=0 or $result[3]!=0 or $result[4]!=0 or $result[5]!=0 or $result[6]!=0 or $result[7]!=0 or $result[8]!=0) 
  {
	...
	echo( "<td><div align=\"center\">".$result[30]."</div></td>\n" );
	echo( "<td><div align=\"left\">".$result[28]."</div></td>\n" );
	echo( "<td><div align=\"left\">".$per ->nbrtocom('vacccinvet','com',$result[29])."</div></td>\n" );
