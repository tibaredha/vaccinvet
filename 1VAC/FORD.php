...
//1ERE page
$pdf->AddPage();
$pdf->enteteord("Ordonnance",$_POST["bilan"],$_POST["N"],$_POST["a1"],strtoupper($_POST["a3"]),ucwords($_POST["a4"]),$_POST["a5"],$pdf->nbrtowil('vaccinvet','wil',$_POST["WILAYAR"]),$pdf->nbrtodai2('vaccinvet','dai',$_POST["DAIRA"]),$pdf->nbrtocom3('vaccinvet','comm',$_POST["COMMUNER"]),$_POST["ADRESSE"],$_POST["ESPECE"],$_POST["SEXE"],$_POST["AGE"],$_POST["TAGE"],$_POST["NBR"]);
