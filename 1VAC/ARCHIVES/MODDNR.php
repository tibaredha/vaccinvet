...
{ 
$per ->h(2,500,180,'MODIFIER DONNEUR');
$per -> sautligne (2);
$per -> photos(1000,250);
$per ->f0('index.php?uc=MODDNR1','post');
$per ->submit(100,490,'Modifier Donneur');
$per ->label(100,220,'structure');                $per ->txt(200,220,'str',32,$result->str);
...
$per ->label(100,430,'IDP');                      $per ->txt(200,430,'IDP',32,$result->IDP); 
