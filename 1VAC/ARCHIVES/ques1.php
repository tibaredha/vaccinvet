...
echo"Vos données ont été sauvegardées.";
echo"</br>";
echo"Un grand merci pour votre participation à l’enquête!";
echo"</br>";
echo"Vous trouverez des informations importantes sur le don de sang sous:";
echo"</br>";
echo"Les dates de collecte de sang près de chez vous figurent sous:";
echo"</br>";

echo"Vous pouvez vous enregistrer ici en ligne comme donneur de cellules souches du sang:";
echo"</br>";
echo"Des documents intéressants tout autour du thème du don de sang peuvent être commandés en ligne à l’adresse suivante:";
