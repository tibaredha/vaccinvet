...
//**************************************************************************************************************************************//
$pdf->AddPage();
$pdf->entete("CERTIFICAT DE VACCINATION ANTI-ANTIRABIQUE \n DES CHIENS",$_POST["bilan"],$_POST["N"]);
...
$pdf->SetXY(80,128); 	  
$pdf->cell(10,10,$_POST["b8"],0,0,'C',0);
...
// if ( 
  // $_POST["b1"]!=0 or $_POST["b2"]!=0 or $_POST["b3"]!=0 or $_POST["b4"]!=0 or $_POST["b5"]!=0 or $_POST["b6"]!=0 or $_POST["b7"]!=0
...
{
header("Location: ../index.php?uc=NVACC") ;
}
?>
