...
class vet extends TCPDF
{
  function Code39($xpos, $ypos, $code, $baseline=0.5, $height=5){
    ...
    $this->MultiCell(200,10,$titre,1,'C',0);
    $this->SetXY(05,255);
    $this->MultiCell(200,10,"NB : Ce certificat n'a qu'une valeur sanitaire. \n         Ce document ne peut etre considéré comme attestation du Propriétaire",1,'L',0);
	...
	$this->Text(170,40,"");
	$this->Text(5,90,"Je soussigné (e) Dr : ".$session."  Certifie avoir vacciné ce jour le : ".$this->dateUS2FR($datevaccination)." le/les chiens");
	$this->Text(5,100,"Appartenant à Mr :".$nomeleveur." ".$prenomleveur."  fils de :".$filsde."  N°CIN/PC: ".$CIN);
	$this->Text(5,110,"délivré le : ".$this->dateUS2FR($delivrer)." par la daira de : ".$parladairasde);
	// $this->Text(135,110,$CFN);
	$this->Text(5,120,"demeurant à:".$ar." Commune:".$cr." Daira:".$dr);
	// $this->Text(5,120,$wr);
	$this->Text(15,130,"le nombre total de chiens/chiffres: ");
	$this->Text(65,140,"lettres: ");
