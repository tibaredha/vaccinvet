...
$pdf->corps($_POST["a1"],strtoupper($_POST["a3"]),strtolower($_POST["a4"]),$_POST["a5"],$_POST["a6"],$_POST["a8"],$_POST["a9"],$_POST["a7"],$pdf->nbrtowil('vaccinvet','wil',$_POST["WILAYAR"]),$pdf->nbrtodai2('vaccinvet','dai',$_POST["DAIRA"]),$pdf->nbrtocom3('vaccinvet','comm',$_POST["COMMUNER"]),$_POST["ADRESSE"]);
...
$pdf->corps1($_POST["a1"],strtoupper($_POST["a3"]),strtolower($_POST["a4"]),$_POST["a5"],$_POST["a6"],$_POST["a8"],$_POST["a9"],$_POST["a7"],$pdf->nbrtowil('vaccinvet','wil',$_POST["WILAYAR"]),$pdf->nbrtodai2('vaccinvet','dai',$_POST["DAIRA"]),$pdf->nbrtocom3('vaccinvet','comm',$_POST["COMMUNER"]),$_POST["ADRESSE"]);
...
$sql = "INSERT INTO regvac (WILAYA,DAIRA,NCERTIFICAT,datevac,nomeleveur,zonnelieu,AVN,vacb1,vacb2,vacb3,vacb4,vacb5,vacb6,vacb7,vabc1,vabc2,vabc3,vabc4,vabc5,vabc6,vabc7,vaad1,vaad2,vaad3,vaad4,vaad5,vaad6,vare1,vare2,vare3,vare4,vare5,vare6,WIL,DAI,COM) 
VALUES ('".$_POST["WILAYAR"]."','".$_POST["DAIRA"]."','".$_POST["N"]."','".$_POST["a1"]."','".$_POST["a3"]."_".$_POST["a4"]."','".$_POST["COMMUNER"]."','".$avn."',
